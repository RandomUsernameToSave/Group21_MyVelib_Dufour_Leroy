...
public class OptimalRidePlanning implements RidePlanningStrategy {
	...
	/**
	 * Return the closest docking station with the bike type asked by the user from the starting point, and the closest station with an empty slot from the end point.
